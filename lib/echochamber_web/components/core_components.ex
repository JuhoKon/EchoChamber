defmodule EchochamberWeb.CoreComponents do
  @moduledoc """
  ...
  use EchochamberWeb, :verified_routes

  alias Phoenix.LiveView.JS
  alias Echochamber.Accounts

  import EchochamberWeb.Gettext
  ...
  def simple_form(assigns) do
    ...
    <.form :let={f} for={@for} as={@as} {@rest}>
      <div class="mt-10 space-y-8 bg-white">
        ...
        <div :for={action <- @actions} class="mt-2 flex items-center justify-between gap-6 flex-row-reverse">
  ...
  def table(assigns) do
    ...
    <div class="overflow-y-auto px-4 sm:overflow-visible sm:px-0">
      <table class="w-[40rem] mt-8 sm:w-full">
        <thead class="text-xs text-left leading-6 text-zinc-500">
          <tr>
        ...
        <tbody
          ...
          class="relative divide-y divide-zinc-100 border-t border-zinc-200 text-xs leading-6 text-zinc-700"
        >
          <tr :for={row <- @rows} id={@row_id && @row_id.(row)} class="group hover:bg-zinc-50">
            ...
            >
              <div class="block py-4 pr-6">
                ...
                <span class={["relative", i == 0 && "font-semibold text-black"]}>
                  <%= render_slot(col, @row_item.(row)) %>
                </span>
              </div>
            </td>
            <td :if={@action != []} class="relative w-14 p-0">
              <div class="relative whitespace-nowrap py-4 text-right text-xs font-medium">
                <span class="absolute -inset-y-px -right-4 left-0 group-hover:bg-zinc-50 sm:rounded-r-xl" />
                <span
                  :for={action <- @action}
                  class="relative ml-4 font-semibold leading-6 text-black hover:text-zinc-700"
                >
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(EchochamberWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(EchochamberWeb.Gettext, "errors", msg, opts)
    end
  end
